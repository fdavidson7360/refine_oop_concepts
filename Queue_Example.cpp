...
class Queue { 
	...
	void add(int arg)
	{
        // since this is a pointer to an array, we can add the new element to the end of the array using the size variable as the index, 
        // and then increment the size variable to reflect the new size of the queue.
		queue[size] = arg;
		size++;
	}
